...
<form method="post" action="gen-ca.php">
	<dl>
		<dt>Username</dt>
	...
	<dl>
		<dt>Days</dt>
		<dd><input type="number" name="days" value="365"></dd>
	</dl>
	<dl>
		<dt>Common name</dt>
		<dd><input type="text" name="commonName" value="geteduroam CA"></dd>
	</dl>
